          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: percentage >= 50 ? Colors.deepPurpleAccent.withOpacity(0.1) : Colors.deepPurpleAccent.withOpacity(0.1),
              ),
              child: Icon(
                percentage >= 50 ? Icons.emoji_events : Icons.sentiment_dissatisfied,
                size: 65,
                color: percentage >= 50 ? Colors.deepPurpleAccent : Colors.deepPurpleAccent,
              ),
            ),
            const SizedBox(height: 24),
            Text(
              percentage >= 80 ? "Xuất sắc!" : (percentage >= 50 ? "Làm tốt lắm!" : "Cố gắng hơn nhé!"),
              style: const TextStyle(fontSize: 35, fontWeight: FontWeight.bold, color: Color(0xFF7B61FF)),
            ),
            ...
            TextButton(
              onPressed: () => Navigator.of(context).pop(),
              child: const Text("Quay lại bộ thẻ", style: TextStyle(fontSize: 18,)),
            ),
